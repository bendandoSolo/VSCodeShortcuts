  ...
  return (
    <>
      ...
      <Stack spacing={2} direction="column" alignItems="flex-centre">
        <h2>Next Steps</h2>
        <p>
          <a href="https://www.youtube.com/watch?v=nWIRJBCjls8">Watch Video for more nice shortcuts</a>
        </p>
        <p>Setup basic linting</p>
        <p>Add prettier config</p>

        <p>
          Create page of know answers, some of the shortcuts we know and should test ourselves and then remove from
          project
        </p>
        ...
        <div>
          - make game out of remembering the features, using google drive a spread sheet of features that get pulled in
