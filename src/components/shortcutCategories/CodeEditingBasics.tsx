...
const CodeEditingBasics = () => (
  <>
    ...
    <ThreeColumnsContainer>
      ...
      <ShortCut
        Shortcut="ALT +  SHIFT + &uarr;/&darr;"
        Line2="Duplicate lines up and down (or use for entire selection)"
      />

      <ShortCut
        Shortcut="CTRL + D"
        Line2="Highlights that word, repeatedly CTRL + D highlights the next word with the same text + adds cursor to it"
        Line3="Can be used to highlight and edit multiple words as cursors appears on each one"
      />

      <ShortCut
        Shortcut="CTRL + SHIFT L on highlighted word"
        Line2="Highlights any instance of that word adds cursor so can edit"
      />
      ...
      <ShortCut
        Shortcut="3 clicks or CTRL + L/ 4 clicks"
        Line2="Select Entire Line, with CTRL + L pressing multiple times keeps selecting next lines/ Select Entire Doc"
      />
